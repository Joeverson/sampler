...
export let sounds = {
  ...
  load: function (sources) {
    ...
    sources.forEach((source) => {
      ...
      if (self.audioExtensions.indexOf(extension) !== -1) {
        ...
        var soundSprite = self.makeSound(source, self.loadHandler.bind(self), true, false, self.onFailed);
  ...
  */
  ...
  makeSound(source, loadHandler, loadSound, xhr, failHandler) {
    ...
    o.startTime = 0;
    o.startOffset = 0;
    o.currentTime = actx.currentTime;
  ...
  loadSound(o, source, loadHandler, failHandler) {
    ...
    xhr.addEventListener("load", this.decodeAudio.bind(this, o, xhr, loadHandler, failHandler));
  ...
  */
  ...
  impulseResponse(duration, decay, reverse, actx) {
